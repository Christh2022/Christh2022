...
Développeur Full Stack passionné avec **3+ années d'expérience** dans la création d'applications innovantes et performantes. Spécialisé dans le développement d'applications mobiles natives et web, avec une Connaissance en architecture microservices et solutions cloud.
